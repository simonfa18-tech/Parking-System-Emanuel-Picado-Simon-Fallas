...
public class ManagementVehicleView extends JInternalFrame {
    ...
    private JButton btnEdit, btnDelete, btnAddOwner, btnRefresh, btnSearch, btnShowAll;
    ...
    public ManagementVehicleView(ParkingLotController parkingController,
    ...
    private void init() {
        ...
        searchPanel.add(new JLabel("Plate:"));
    ...
    private void searchVehicle() {
        ...
        if (plate.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Enter a plate");
            return;
        }
