...
public class SpaceView extends JInternalFrame {
    ...
    public SpaceView(ParkingLot parkingLot, SpaceController controller, VehicleTypeController vehicleTypeController) {
        super("Configuración de Espacios", false, true, false, true);
    ...
    private void init() {
        for (Space space : parkingLot.getSpaces()) {
            ...
            VehicleType selectedType = (VehicleType) JOptionPane.showInputDialog(
                    this,
                    "Seleccione tipo para el espacio #" + space.getId() + "Discapacidad: " + (space.isDisabilityAdaptation() ? "si" : "no"),
                    "Configurar espacio",
        ...
        JOptionPane.showMessageDialog(this, "Espacios configurados correctamente");
        dispose();
    }
